    ...
    <div class="border border-gray-300 shadow-lg rounded-lg w-full">
        <div class="px-5 py-3 bg-gray-100 rounded-t-lg border-b border-gray-300">
            <div class="flex gap-1 items-center">
                ...
                <p class="text-sm">Data Referensi Struktural</p>
            </div>
        </div>
        <div class="bg-white px-5 py-5 rounded-b-lg">
            <div class="flex items-center justify-between mb-5">
                <a href="{{ route('struktural.create') }}"
                    ...
                    <table id="datatable" class="text-sm hover stripe row-border">
                        <thead class="bg-bay-950 text-white font-bold">
                            <tr>
                                ...
                                <td class="text-xs !text-center whitespace-nowrap">Kode Struktural</td>
                                <td class="text-xs !text-center">Uraian</td>
                        ...
                        <tbody class="text-secondary-2">
                            @foreach ($data as $item)
                                <tr class="text-xs">
                                    ...
                                    <td>
                                        <p class="text-center">{{ $item->kdstruk }}</p>
                                    </td>
                                    <td>
                                        <p class="text-center">{{ $item->uraian }}</p>
                                    </td>
                                    <td>
                                        <p class="text-center">Rp. {{ number_format($item->rp_struk, 0, ',', '.') }}</p>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
