            ...
            <div class="w-full md:max-w-[40%] px-3 md:px-0 flex items-center">
                <div
                    ...
                    <div
                        ...
                        <div class="w-full">
                            <div class="flex-col flex justify-center items-center pb-2 border-b border-spindle-300">
                                <p class="text-spindle-900 font-extrabold text-center md:text-xl text-lg leading-none">
                                    SIMGRTASN
                                </p>
                                <p class="text-spindle-600 font-medium text-center text-xs leading-5">
                                    Sistem Informasi Gaji, Rapel dan TPP ASN.
                                </p>
                            </div>
                            <div class="py-3">
                                {{ $slot }}
