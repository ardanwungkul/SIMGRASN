...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Page Content -->
        <main class="md:pl-64 pl-2">
            <div>
                <div class="px-5 py-2 bg-white shadow-lg h-[72.67px] -ml-2 ">
                    <div class="flex justify-between items-center h-full px-5">
                        <div class="flex flex-col items-center">
                            <p class="font-semibold md:text-base text-lg text-gray-800">
                                Bulan Transaksi
                            <div class="flex gap-2 items-center group cursor-pointer">
                                <div
                                    class="border-[1.5px] border-bay-950 group-hover:bg-bay-950 rounded-lg font-extrabold text-bay-950 group-hover:text-white transition-all duration-300 px-2 py-1 h-8 flex items-center gap-2">
                        ...
                        <div class="flex items-center gap-3 flex-none">
                            <div class="text-end hidden md:block">
                                ...
                                <p class="text-xs">
                                    {{ \Carbon\Carbon::now()->locale('id')->isoFormat('ddd, DD MMM YYYY') }}</p>
                            </div>
                            <div>
                                <button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar"
                                    data-dropdown-placement="bottom-end"
                                    class="flex items-center justify-center text-sm rounded-full md:me-0 focus:ring-2 w-8 h-8 border border-gray-300"
                                    type="button">
            ...
            <div class="p-5">
                ...
                @endif --}}
                {{-- <div class="bg-white rounded-lg px-5 py-2 shadow-lg mb-3">
                    <div class="flex justify-between items-center">
                        <p class="font-bold">Bulan Transaksi</p>
                        <div class="flex gap-2 items-center">
                            <div class="bg-bay-950 rounded-lg text-white px-2 py-1 h-8 flex items-center">
                                <p class="text-sm self-center">
                                    {{ \App\Helpers\FormatHelper::formatThnBln(session('thnbln')) }}
                                </p>
                            </div>
                            <button class="bg-bay-950 text-white px-2 py-1 rounded-lg h-8 w-8">
